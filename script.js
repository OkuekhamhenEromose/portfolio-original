document.addEventListener("DOMContentLoaded", function () {
  ...
  ScrollReveal().reveal(".home-content .hero-buttons", {
    delay: 700,
    origin: "left",
  });
  ...
  ScrollReveal().reveal(".about-content h3, .about-content p", {
    delay: 500,
    origin: "right",
  });
  ...
  ScrollReveal().reveal(".info-cards .info-card", {
    delay: 500,
    origin: "bottom",
    interval: 300,
  });
  ScrollReveal().reveal(".filter-btn", {
    delay: 500,
    origin: "right",
    interval: 300,
  });
  ...
  ScrollReveal().reveal(".learning-section h3, .contact-form-section h3", {
    delay: 500,
    origin: "top",
  });
  ScrollReveal().reveal(".learning-item", {
    delay: 500,
    origin: "left",
    interval: 300,
  });
  ScrollReveal().reveal(".form-group", { delay: 500, origin: "right" });
  ScrollReveal().reveal(".btn-contact-info button", {
    delay: 500,
    origin: "bottom",
    interval: 200,
  });
  ...
  document.addEventListener("click", function (event) {
    if (window.innerWidth <= 992) {
      ...
      const isClickInsideNav =
        navMenu.contains(event.target) || navToggleBtn.contains(event.target);
  ...
  const projects = [
    {
      ...
      demoLink: "timely-axolotl-0f4be3.netlify.app",
    ...
    },
    {
      ...
      description:
        "Property listings app for buying or renting homes. Featuring search, filters, and clean UI",
      tags: ["frontend"],
      image: "images/realestate-img.png",
      demoLink: "dancing-youtiao-914380.netlify.app",
    ...
    },
    {
      ...
      demoLink: "https://splendorous-custard-21ddd9.netlify.app/",
    ...
    filteredProjects.forEach((project) => {
      ...
      <div class="project-content">
        ...
        <div class="project-links">
          <a href="${project.demoLink}" target="_blank" rel="noopener noreferrer" class="btn">View Demo</a>
